...
function SingleUser() {
  ...
  const {user, fetchSingleUser,getRepos, repos, loading} = useContext(GithubContext)
       ...
       <div className="w-full mx-auto lg:w-10/12">
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-3 mb-8 md:gap-8">
            <div className="custom-card-image card-image md:mb-0">
                  ...
                  blog && (
                    <div className="stat">
                      ...
                      <div className="stat value text-lg">
                        <a href={`https://${blog}`} target="_blank" rel='noreferrer'>Website</a>
                      </div>
